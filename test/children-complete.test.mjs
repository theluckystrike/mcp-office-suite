...
test.skip("CHILDREN covers every stdio server in the estate", () => {
...
test.skip("every CHILDREN entry names the package that server actually publishes", () => {
  const expected = stdioServers();
 ...
 */
test.skip("control: the completeness assertion fails when an entry is removed", () => {
